...
class RabbitMQClient:
    ...
    async def connect(self):
        ...
        # Set Fair Dispatch for all consumers on this channel
    ...
    async def declare_queue(self, name: str, durable: bool = True, arguments: dict = None):
        await self.channel.declare_queue(name, durable=durable, arguments=arguments)
